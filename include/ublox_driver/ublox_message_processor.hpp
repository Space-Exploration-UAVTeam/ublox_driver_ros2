...
class UbloxMessageProcessor
{
    ...
    UbloxMessageProcessor(const std::shared_ptr<rclcpp::Node> nh);
...
private:
    ...
    rclcpp::Publisher<GnssPVTSolnMsg>::SharedPtr pub_pvt_;
    rclcpp::Publisher<NavSatFix>::SharedPtr pub_lla_;
    rclcpp::Publisher<GnssTimePulseInfoMsg>::SharedPtr pub_tp_info_;
    rclcpp::Publisher<GnssMeasMsg>::SharedPtr pub_range_meas_;
    rclcpp::Publisher<GnssEphemMsg>::SharedPtr pub_ephem_;
    rclcpp::Publisher<GnssGloEphemMsg>::SharedPtr pub_glo_ephem_;
    rclcpp::Publisher<StampedFloat64Array>::SharedPtr pub_iono_;
